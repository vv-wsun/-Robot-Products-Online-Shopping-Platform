...
<body id="page-top" class="index" >
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#contact">Contact</a>
                                        ...
                                        <li>
                        <a class="page-scroll" href="#robotmodal" data-toggle="modal">Robots</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Welcome To Robot Home!</div>
	...
	<% ArrayList<Product> proAL= (ArrayList<Product>)session.getAttribute("proAL");
    	...
    	out.print("<div class='col-md-4 col-sm-6 portfolio-item'>"+
                    "<a href='#robotPage2' class='portfolio-link' data-toggle='modal'>"+
                        "<div class='portfolio-hover'>"+
                            "<div class='portfolio-hover-content'>"+
                                "<i class='fa fa-plus fa-3x'></i>"+
                            "</div>"+
                        "</div>"+
                        "<img src='img/profolio/startup-framework.png' class='img-responsive' alt=''>"+
                    "</a>"+
                    "<div class='portfolio-caption'>"+
                        "<h4>"+name+"</h4>"+
                        "<p class='text-muted'>"+price+"</p>"+
                    "</div>"+"<p id='hahaha'>balabala</p>"+
                "</div>");
		} %>
            </div>
        </div>
  ...
  <!-- Robot Modal daohang-->
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted" id="test">There are the products you can purchase!</p>
    ...
    <!-- Robots Modal 2 -->
    <div class="portfolio-modal modal fade" id="robotPage2" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                <h2>Printing Robot</h2>
                                <p class="item-intro text-muted">Helping you to print different types of bala</p>
...
if(username!="null"){
	$("#hiden").hide();
	$("ul").append("<li style='color: #0CF'><a class='page-scroll' href='http://www.baidu.com'>"+username+"</a></li>");
}
